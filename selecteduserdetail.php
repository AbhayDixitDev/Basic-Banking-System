...
?>
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : #23a4f9;"><b>Transaction</b></h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <br><br><br>
        <label style="color : #23a4f9;"><b>Transfer To:</b></label>
        ...
        <br>
        <br>
            <label style="color : #23a4f9;"><b>Amount:</b></label>
